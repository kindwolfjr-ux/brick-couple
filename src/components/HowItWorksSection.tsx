...
const steps = [
  {
    ...
    description: "Пришлите фото себя и своей пары",
    icon: Camera,
    color: "#D9443D",
  },
  {
    number: 2,
    title: "Мы подбираем детали LEGO",
    description: "Выбираем оригинальные элементы, похожие на вас",
    icon: Search,
    color: "#2451B6",
  },
  {
    number: 3,
    title: "Собираем вашу мини-пару",
    description: "Каждая фигурка собирается вручную с вниманием к деталям",
    icon: Wrench,
    color: "#FFD000",
  },
  {
    ...
    description: "Готово к подарку или украшению комнаты",
    icon: Gift,
    color: "#D9443D",
  },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Четыре простых шага до вашей уникальной LEGO-пары
          </p>
        </motion.div>
